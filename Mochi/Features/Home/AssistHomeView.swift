...
struct AssistHomeView: View {
    ...
    private var listenControl: some View {
        Button {
            ...
            ZStack {
                Circle()
                    .stroke(MochiTheme.ink.opacity(0.12), lineWidth: 2)
                ...
                Circle()
                    .fill(
                        LinearGradient(
                            colors: [Color.white, MochiTheme.mint.opacity(0.9)],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        )
                    )
                    .frame(width: 246, height: 246)
                    .shadow(color: MochiTheme.ink.opacity(0.13), radius: 28, y: 15)
                ...
                Text(listenLabel)
                    ...
                    .padding(.horizontal, 20)
                    .padding(.vertical, 9)
                    .background(MochiTheme.ink, in: Capsule())
                    .offset(y: 100)
    ...
    private var featureControls: some View {
        ...
        .foregroundStyle(MochiTheme.text)
        .background(MochiTheme.surface.opacity(0.95), in: RoundedRectangle(cornerRadius: 24, style: .continuous))
        .overlay(RoundedRectangle(cornerRadius: 24).stroke(MochiTheme.divider.opacity(0.7)))
    ...
    private func featureIcon(_ name: String) -> some View {
        Image(systemName: name)
            ...
            .background(MochiTheme.mint, in: Circle())
    }
    ...
    private var hearingTools: some View {
        ...
        .tint(MochiTheme.ink)
        .padding(16)
        .background(MochiTheme.surface.opacity(0.9), in: RoundedRectangle(cornerRadius: 22, style: .continuous))
        .overlay(RoundedRectangle(cornerRadius: 22).stroke(MochiTheme.divider.opacity(0.6)))
    }
